  ...
  return (
    ...
    >
      <div className="md:w-2/3 lg:w-1/2 container px-5 md:px-16 mx-auto">
        <h1 className="capitalize m-10 text-black1 flex flex-col gap-2 md:gap-5 text-3xl sm:text-4xl md:text-[3.2rem] 2xl:text-6xl font-bold">
         
          English-Speaking Cleaning Services in Germany
             
          
        </h1>
        <p className="text-lg text-black1 font-bold leading-normal sm:leading-loose my-4 md:my-6">
